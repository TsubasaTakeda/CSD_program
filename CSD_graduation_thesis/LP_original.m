...
for num_node = num_node_array
    ...
    for num_depot = num_depot_array
        ...
        for per_driver = per_driver_array
            ...
            filename = strcat("result/result_original/num_driver_", num2str(sum_driver), "/node_", num2str(num_node), "/depot_", num2str(num_depot));
            time_filename = strcat(filename, "/time/LP_original_time_", num2str(sum_driver), "_", num2str(num_node), "_", num2str(num_depot), ".csv");
            obj_filename = strcat(filename, "/obj/LP_original_obj_", num2str(sum_driver), "_", num2str(num_node), "_", num2str(num_depot), ".csv");
            
            foldername = strcat(filename, "/time");
            mkdir(foldername);
            ...
            for net_num = 0:num_networks-1
                for exp_num = 0:num_experience-1
                    ...
                    filename = strcat("input/num_driver_", num2str(sum_driver), "/node_", num2str(num_node), "/depot_", num2str(num_depot) + "/net_", num2str(net_num));
                    driver_cost_atomic_filename = strcat(filename, "/cost_atomic/cost_atomic_driver_", num2str(num_node), "_", num2str(num_depot), "_", num2str(net_num), "_", num2str(exp_num), ".csv");
                    task_cost_atomic_filename = strcat(filename, "/cost_atomic/cost_atomic_task_", num2str(num_node), "_", num2str(num_depot), "_", num2str(net_num), "_" + num2str(exp_num), ".csv");
                    demand_filename = strcat(filename, "/demand/demand_", num2str(num_node), "_", num2str(num_depot), "_", num2str(net_num), "_" + num2str(exp_num), ".csv");
                    ...
                    filename = strcat("result/result_original/num_driver_", num2str(sum_driver), "/node_", num2str(num_node), "/depot_", num2str(num_depot));
                    driver_allocation_filename = strcat(filename, "/net_", num2str(net_num), "/allocation_", num2str(exp_num), "/driver_allocation_", num2str(sum_driver), "_", num2str(num_node), "_", num2str(num_depot), "_", num2str(net_num), "_", num2str(exp_num), ".csv");
                    task_allocation_filename = strcat(filename, "/net_", num2str(net_num), "/allocation_", num2str(exp_num), "/task_allocation_", num2str(sum_driver), "_", num2str(num_node), "_", num2str(num_depot), "_", num2str(net_num), "_", num2str(exp_num), ".csv");
                    
                    filename = strcat(filename, "/net_", num2str(net_num), "/allocation_", num2str(exp_num));
                    ...
                    %size(atomic_allocation_driver)
                    %size(atomic_allocation_task)
                    
                    %sum(atomic_allocation_driver, 1);
                    %sum(sum(atomic_allocation_driver, 1), 2);
                    %sum(atomic_allocation_task, 1);
